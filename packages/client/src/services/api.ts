...
export const api = {
  ...
  upgradeBuilding:(keepId: number, buildingId: number) => post<{ building: Building; upgradeCost: Array<{ resource: string; quantity: number }> }>(`/api/keeps/${keepId}/buildings/${buildingId}/upgrade`),
